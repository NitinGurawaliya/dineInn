...
const BottomNavbar = () => {
  return (
    <div className="fixed bottom-0 left-10 right-10 md:left-80 md:right-80 rounded-full  bg-orange-800 flex justify-around items-center py-3 shadow-md z-1000">
