...
restaurantRouter.post("/onboarding", authMiddleware_1.authMiddleware, upload.fields([{ name: "upiQr", maxCount: 1 }, { name: "Logo", maxCount: 1 }]), restaurant_controller_1.restaurantDetails);
